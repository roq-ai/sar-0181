      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('tour', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/tours/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/bookings/create?tour_id=${data?.id}`}>
                      ...
                      <Tbody>
                        {data?.booking?.map((record) => (
                          <Tr
                            ...
                            key={record.id}
                          >
                            <Td>{record.booking_date as unknown as string}</Td>
                            <Td>{record.status}</Td>
                            <Td>
